...
class Object
{
 public:
	...
	Texture* texture;          // Texture to be applied to this object (if any)
	Texture* normal;

    Object(Shape* _shape, const int objectId,
           const glm::vec3 _d=glm::vec3(), const glm::vec3 _s=glm::vec3(), const float _n=1, Texture* texture=NULL, Texture* normal=NULL);
